...
- (id)initWithPhotoBrowser:(MWPhotoBrowser *)browser {
    if ((self = [super init])) {
        ...
        _tapView.backgroundColor = [UIColor clearColor];//Jigar Patel
        ...
        _photoImageView.backgroundColor = [UIColor clearColor];//Jigar Patel
        ...
        self.backgroundColor = [UIColor clearColor];//Jigar Patel
		self.delegate = self;
