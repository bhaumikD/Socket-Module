...
- (id)init {
    ...
    [[NSUserDefaults standardUserDefaults] setBool:true forKey:@"isCallMWPhoto"];
...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = [UIColor clearColor];//Jigar Patel
    self.view.backgroundColor = [[UIColor alloc] initWithRed:0.0 green:0.0 blue:0.0 alpha:0.85];//Jigar Patel
    ...
    _pagingScrollView.backgroundColor = [UIColor clearColor];//Jigar Patel
...
- (void)performLayout {
    ...
    if ([self.navigationController.viewControllers objectAtIndex:0] == self) {
        ...
        UIBarButtonItem *newBackButton = [[UIBarButtonItem alloc] initWithTitle:backButtonTitle style:UIBarButtonItemStylePlain target:self action:@selector(backCall)];
...
- (void)viewWillDisappear:(BOOL)animated {
    ...
    [[NSUserDefaults standardUserDefaults] setBool:false forKey:@"isCallMWPhoto"];
    [[NSUserDefaults standardUserDefaults] synchronize];
